...
datasummary$Genotype = genotype
datasummary$ACR1 = acr1

# plot now
for(v in names(datasummary)[names(datasummary) %in% parameters ] ){
  print(v)
  plot <- ggplot(datasummary, aes(Genotype, datasummary[,v], color = ACR1)) +
