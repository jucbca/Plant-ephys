...
f = list.files()[grep(".RData", list.files()) ][3]
print(f)
load( f )
...
for(i in c(1:(pulses.per.round)) ){
  trace.segmented[[i]][[1]]$Treatment = "baseline"# treatment# "petioleCut"   #
...
for(i in c( (pulses.per.round+1)  : (pulses.per.round*2)  )){
  trace.segmented[[i]][[1]]$Treatment = "cut" # # "petioleCut" # 
  trace.segmented[[i]][[2]]$Treatment = "cut" # 
  trace.segmented[[i]][[1]]$Treatment.time = 0
  trace.segmented[[i]][[2]]$Treatment.time = 0
}
